...
{
    public const float scrollSpeedX = 0.2f;
    public const float scrollSpeedY = 0.1f;
    ...
    void Update()
    {
        ...
        newOffset.Set(newOffset.x + (scrollSpeedX * Time.deltaTime), newOffset.y + (scrollSpeedY * Time.deltaTime));
